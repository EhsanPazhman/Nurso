        ...
        <aside
            ...
            <nav class="flex flex-col gap-8">
                ...
                <a href="{{ route('staff.register') }}" class="group relative flex items-center justify-center">
                    ...
                    <span
                        class="absolute left-20 bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">Staff</span>
                </a>
            </nav>
