            ...
            <form wire:submit.prevent="save" class="p-8 space-y-12">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-widest">First
                                Name
                        ...
                        <div class="space-y-2">
                            <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-widest">Last
                                Name
                                <span class="text-red-500">*</span></label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-widest">Gender
                                <span class="text-red-500">*</span></label>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <label
                                class="block text-[11px] font-bold text-slate-700 uppercase tracking-widest">Secondary
                                Phone</label>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            <label
                                class="block text-[11px] font-bold text-slate-700 uppercase tracking-widest">Department
                                <span class="text-red-500">*</span></label>
