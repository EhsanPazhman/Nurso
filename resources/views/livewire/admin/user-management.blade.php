<div class="max-w-6xl mx-auto mt-10 px-4 pb-20">
    ...
    <!-- Search & Filter Bar -->
    <div
        class="bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl p-4 rounded-[2rem] border border-white/20 dark:border-slate-800/50 shadow-xl mb-8 flex flex-col md:flex-row gap-4">
